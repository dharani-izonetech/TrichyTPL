    ...
    <section className="min-h-screen py-10 px-4 md:px-8">
      <div className="mb-10">
        ...
        <p className="mt-4 text-slate-400 max-w-2xl text-base">
          Stay updated with the latest happenings, transfers, and match reports from the TPL.
        </p>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          {newsList.length === 0 && (
             <div className="text-center py-20 bg-panelSoft/10 rounded-3xl border border-white/5">
