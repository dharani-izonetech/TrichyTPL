...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 h-20 border-b border-slate-800/70 bg-bg/95 backdrop-blur flex items-center">
      <nav className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-4 px-4 md:px-8">
